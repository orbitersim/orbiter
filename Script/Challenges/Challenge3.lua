...
data_path = 'Script/Challenges/Challenge3.dat' -- high score file
max_score = 10 -- max high score entries

intro = 'Flight challenge:\n\
Advanced lunar transfer: Transfer to the moon\
and dock with orbiting wheel, Luna-Ob1. Minimize\
fuel use.\n\
This time you need to consider plane alignments.\n'
