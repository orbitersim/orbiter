...
void DInput::OptionChanged(uint32_t cat, uint32_t item)
{
...
uint32_t DInput::SetJoystickProperties ()
{
	// LPDIRECTINPUTDEVICE8 dev = GetJoyDevice();
	// if (!dev) return DI_OK;
	//
