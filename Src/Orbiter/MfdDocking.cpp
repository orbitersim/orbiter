...
void Instrument_Docking::UpdateDraw (oapi::Sketchpad *skp)
{
	...
	skp->Text(circx, circy - (circr * 116) / 100, "0º", 3);
	if (scale) {
		skp->Text(circx + circr / 2, circy+1, "2º", 3);
		skp->Text(circx + circr, circy+1, "4º", 3);
		skp->Text(circx - (circr * 54) / 100, circy - (circr * 102) / 100, "3º", 3);
		skp->Text(circx + (circr * 54) / 100, circy - (circr * 102) / 100, "3º", 3);
	}
	else {
		skp->Text(circx + circr / 2, circy+1, "10º", 4);
		skp->Text(circx + circr, circy+1, "20º", 4);
		skp->Text(circx - (circr*54)/100, circy - (circr*102)/100, "30º", 4);
		skp->Text(circx + (circr*54)/100, circy - (circr*102)/100, "30º", 4);
	}
