...
void Atlantis::VLiftCoeff (double aoa, double M, double Re, double *cl, double *cm, double *cd)
{
    ...
    static const double CLMachHigh[nabsc] = {-0, 0.3, 0.7, 1.1, 1.4, 1.2, -0, -1.2, -1.4, -1.1, -0.7, -0.3, 0, 0.3, 0.7, 1.1, 1.4, 1.2, 0, -1.2, -1.4, -1.1, -0.7, -0.3, 0};
    ...
    double cd_prof_high = 0.15 + 1.00 * pow(sin(aoa), 2); // profile drag coefficient at high Mach
