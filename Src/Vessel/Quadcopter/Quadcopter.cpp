...
void Quadcopter::clbkSetClassCaps(FILEHANDLE cfg)
{
	const TOUCHDOWNVTX tdv[12] = {
		{ {-0.3, -0.26,  0.3}, 1e3, 5e1, 1.6, 1.6 },
		{ {-0.3, -0.26, -0.3}, 1e3, 5e1, 1.6, 1.6 },
		{ { 0.3, -0.26, -0.3}, 1e3, 5e1, 1.6, 1.6 },
		{ { 0.3, -0.26,  0.3}, 1e3, 5e1, 1.6 },
		{ { 0.6, 0.15,  0.4}, 1e3, 5e1, 1.6 },
		{ { 0.6, 0.15, -0.4}, 1e3, 5e1, 1.6 }, 
		{ {-0.6, 0.15,  0.4}, 1e3, 5e1, 1.6 },
		{ {-0.6, 0.15, -0.4}, 1e3, 5e1, 1.6 },
		{ { 0.4, 0.15,  0.6}, 1e3, 5e1, 1.6 },
		{ {-0.4, 0.15,  0.6}, 1e3, 5e1, 1.6 },
		{ { 0.4, 0.15, -0.6}, 1e3, 5e1, 1.6 },
		{ {-0.4, 0.15, -0.6}, 1e3, 5e1, 1.6 }
	};
	...
	SetEmptyMass(2.0);
	SetSize(0.3);
	SetPMI({0.02, 0.05, 0.02});
	SetCrossSections({0.1, 0.6, 0.1});
	...
	th = CreateThruster({0, 0, 0}, {0, 1, 0}, 1e-10, ph, 1e-5, 1e-5);
