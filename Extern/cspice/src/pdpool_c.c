...
-Detailed_Input
   ...
   name        is the name of the kernel pool variable to associate
               with the values supplied in the array `values'. 'name'
               is restricted to a length of 32 characters or less.
...
-Version
   ...
   -CSPICE Version 1.2.0, 27-AUG-2021 (JDR)

       Changed the output argument name "dvals" to "values" for
   ...
   -CSPICE Version 1.1.0, 24-JUL-2001 (NJB)
       ...
       Changed prototype: input values is now type (ConstSpiceDouble *).
       Implemented interface macro for casting input values to const.
