...
INT WINAPI WinMain( HINSTANCE hInst, HINSTANCE, LPSTR strCmdLine, INT )
{
    ...
    g_hWnd = CreateWindow( TEXT("Render Window"),
	                       TEXT("D3D Tutorial: Enumeration devices"),
	...
	// Ask the user to select a device. This call enumerates the available
	// drivers, devices, and modes, and displays them in a dialog box for the
	// user.
