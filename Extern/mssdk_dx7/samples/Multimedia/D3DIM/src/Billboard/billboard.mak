...
!MESSAGE No configuration specified.  Defaulting to billboard - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "billboard - Win32 Release" && "$(CFG)" !=\
 "billboard - Win32 Debug"
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "billboard - Win32 Debug"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/billboard.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/billboard.pdb" /machine:I386 /out:"$(OUTDIR)/billboard.exe" 
LINK32_OBJS= \
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/billboard.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/billboard.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/billboard.exe" 
LINK32_OBJS= \
	"$(INTDIR)\billboard.obj" \
	"$(INTDIR)\winmain.res"
...
"$(INTDIR)\billboard.obj" : $(SOURCE) $(DEP_CPP_BILLB) "$(INTDIR)"
