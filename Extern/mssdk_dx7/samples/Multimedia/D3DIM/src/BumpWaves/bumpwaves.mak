...
!IF "$(CFG)" != "BumpWaves - Win32 Release" && "$(CFG)" !=\
 "BumpWaves - Win32 Debug"
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "BumpWaves - Win32 Debug"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/BumpWaves.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD LINK32 ddraw.lib dxguid.lib winmm.lib ..\..\lib\d3dframe.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /machine:I386
LINK32_FLAGS=ddraw.lib dxguid.lib winmm.lib ..\..\lib\d3dframe.lib kernel32.lib\
 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib\
 ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /incremental:no\
 /pdb:"$(OUTDIR)/BumpWaves.pdb" /machine:I386 /out:"$(OUTDIR)/BumpWaves.exe" 
LINK32_OBJS= \
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/BumpWaves.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
# ADD LINK32 ddraw.lib dxguid.lib winmm.lib ..\..\lib\d3dframe.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /debug /machine:I386
LINK32_FLAGS=ddraw.lib dxguid.lib winmm.lib ..\..\lib\d3dframe.lib kernel32.lib\
 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib\
 ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /incremental:yes\
 /pdb:"$(OUTDIR)/BumpWaves.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/BumpWaves.exe" 
LINK32_OBJS= \
	"$(INTDIR)\bumpwaves.obj" \
	"$(INTDIR)\winmain.res"
...
"$(INTDIR)\bumpwaves.obj" : $(SOURCE) $(DEP_CPP_BUMPW) "$(INTDIR)"
