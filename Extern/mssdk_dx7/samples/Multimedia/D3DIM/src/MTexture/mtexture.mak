...
!IF "$(CFG)" == ""
CFG=mtexture - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to mtexture - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "mtexture - Win32 Release" && "$(CFG)" !=\
 "mtexture - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "mtexture.mak" CFG="mtexture - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "mtexture - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "mtexture - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "mtexture - Win32 Debug"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe

!IF  "$(CFG)" == "mtexture - Win32 Release"
...
ALL : "$(OUTDIR)\mtexture.exe"

CLEAN : 
	-@erase "$(INTDIR)\mtexture.obj"
	-@erase "$(INTDIR)\winmain.res"
	-@erase "$(OUTDIR)\mtexture.exe"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/mtexture.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/mtexture.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/mtexture.pdb" /machine:I386 /out:"$(OUTDIR)/mtexture.exe" 
LINK32_OBJS= \
	"$(INTDIR)\mtexture.obj" \
	"$(INTDIR)\winmain.res"

"$(OUTDIR)\mtexture.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "mtexture - Win32 Debug"
...
CLEAN : 
	...
	-@erase "$(INTDIR)\winmain.res"
	-@erase "$(OUTDIR)\mtexture.exe"
	-@erase "$(OUTDIR)\mtexture.ilk"
	-@erase "$(OUTDIR)\mtexture.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/mtexture.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/mtexture.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/mtexture.exe" 
LINK32_OBJS= \
	"$(INTDIR)\mtexture.obj" \
	"$(INTDIR)\winmain.res"
...
# Name "mtexture - Win32 Release"
# Name "mtexture - Win32 Debug"
