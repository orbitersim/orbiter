...
!MESSAGE No configuration specified.  Defaulting to filter - Win32 Debug.
!ENDIF 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "filter - Win32 Debug"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe
...
ALL : "$(OUTDIR)\filter.exe"

CLEAN : 
	-@erase "$(INTDIR)\filter.obj"
	-@erase "$(INTDIR)\winmain.res"
	-@erase "$(OUTDIR)\filter.exe"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/filter.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/filter.pdb" /machine:I386 /out:"$(OUTDIR)/filter.exe" 
LINK32_OBJS= \
	"$(INTDIR)\filter.obj" \
	"$(INTDIR)\winmain.res"

"$(OUTDIR)\filter.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(INTDIR)\winmain.res"
	-@erase "$(OUTDIR)\filter.exe"
	-@erase "$(OUTDIR)\filter.ilk"
	-@erase "$(OUTDIR)\filter.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/filter.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/filter.pdb" /debug /machine:I386 /out:"$(OUTDIR)/filter.exe" 
LINK32_OBJS= \
	"$(INTDIR)\filter.obj" \
	"$(INTDIR)\winmain.res"
