...
!MESSAGE No configuration specified.  Defaulting to mipmap - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "mipmap - Win32 Release" && "$(CFG)" != "mipmap - Win32 Debug"
...
!MESSAGE 
!MESSAGE "mipmap - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "mipmap - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "mipmap - Win32 Debug"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe
...
ALL : "$(OUTDIR)\mipmap.exe"

CLEAN : 
	-@erase "$(INTDIR)\mipmap.obj"
	-@erase "$(INTDIR)\winmain.res"
	-@erase "$(OUTDIR)\mipmap.exe"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/mipmap.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/mipmap.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/mipmap.pdb" /machine:I386 /out:"$(OUTDIR)/mipmap.exe" 
LINK32_OBJS= \
	"$(INTDIR)\mipmap.obj" \
	"$(INTDIR)\winmain.res"

"$(OUTDIR)\mipmap.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(INTDIR)\winmain.res"
	-@erase "$(OUTDIR)\mipmap.exe"
	-@erase "$(OUTDIR)\mipmap.ilk"
	-@erase "$(OUTDIR)\mipmap.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/mipmap.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/mipmap.pdb" /debug /machine:I386 /out:"$(OUTDIR)/mipmap.exe" 
LINK32_OBJS= \
	"$(INTDIR)\mipmap.obj" \
	"$(INTDIR)\winmain.res"
