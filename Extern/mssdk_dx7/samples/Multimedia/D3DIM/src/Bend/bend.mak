...
!IF "$(CFG)" == ""
CFG=bend - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to bend - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "bend - Win32 Release" && "$(CFG)" != "bend - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "bend.mak" CFG="bend - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "bend - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "bend - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "bend - Win32 Debug"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe

!IF  "$(CFG)" == "bend - Win32 Release"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/bend.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/bend.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/bend.pdb" /machine:I386 /out:"$(OUTDIR)/bend.exe" 
LINK32_OBJS= \
	"$(INTDIR)\bend.obj" \
	"$(INTDIR)\winmain.res"

"$(OUTDIR)\bend.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "bend - Win32 Debug"
...
CLEAN : 
	...
	-@erase "$(INTDIR)\winmain.res"
	-@erase "$(OUTDIR)\bend.exe"
	-@erase "$(OUTDIR)\bend.ilk"
	-@erase "$(OUTDIR)\bend.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/bend.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/bend.pdb" /debug /machine:I386 /out:"$(OUTDIR)/bend.exe" 
LINK32_OBJS= \
	"$(INTDIR)\bend.obj" \
	"$(INTDIR)\winmain.res"
...
# Name "bend - Win32 Release"
# Name "bend - Win32 Debug"
...
"$(INTDIR)\bend.obj" : $(SOURCE) $(DEP_CPP_BEND_) "$(INTDIR)"
