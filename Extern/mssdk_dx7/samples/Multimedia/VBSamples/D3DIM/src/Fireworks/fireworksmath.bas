...
Private Function D3DFVF_TEXTCOORDSIZE1(ByVal CoordIndex As Long) As Long
  D3DFVF_TEXTCOORDSIZE1 = ShiftLeft(D3DFVF_TEXTUREFORMAT1, (CoordIndex * 2 + 16))
End Function

Private Function D3DFVF_TEXTCOORDSIZE2(ByVal CoordIndex As Long) As Long
  D3DFVF_TEXTCOORDSIZE2 = D3DFVF_TEXTUREFORMAT2
End Function

Private Function D3DFVF_TEXTCOORDSIZE3(ByVal CoordIndex As Long) As Long
  D3DFVF_TEXTCOORDSIZE3 = ShiftLeft(D3DFVF_TEXTUREFORMAT3, (CoordIndex * 2 + 16))
End Function

Private Function D3DFVF_TEXTCOORDSIZE4(ByVal CoordIndex As Long) As Long
  D3DFVF_TEXTCOORDSIZE4 = ShiftLeft(D3DFVF_TEXTUREFORMAT4, (CoordIndex * 2 + 16))
End Function
