...
!IF "$(CFG)" != "CaptureSound - Win32 Release" && "$(CFG)" !=\
 "CaptureSound - Win32 Debug"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/CaptureSound.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
LINK32_FLAGS=dsound.lib dxguid.lib winmm.lib comctl32.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/CaptureSound.pdb" /machine:I386\
 /out:"$(OUTDIR)/CaptureSound.exe" 
LINK32_OBJS= \
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/CaptureSound.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=dsound.lib dxguid.lib winmm.lib comctl32.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/CaptureSound.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/CaptureSound.exe" 
LINK32_OBJS= \
	"$(INTDIR)\capturesound.obj" \
	"$(INTDIR)\wavwrite.obj" \
...
"$(INTDIR)\wavwrite.obj" : $(SOURCE) $(DEP_CPP_WAVWR) "$(INTDIR)"
...
"$(INTDIR)\capturesound.obj" : $(SOURCE) $(DEP_CPP_CAPTU) "$(INTDIR)"
