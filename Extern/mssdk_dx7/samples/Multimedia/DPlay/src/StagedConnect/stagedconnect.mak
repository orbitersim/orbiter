...
!IF "$(CFG)" == ""
CFG=StagedConnect - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to StagedConnect - Win32\
 Debug.
!ENDIF 

!IF "$(CFG)" != "StagedConnect - Win32 Release" && "$(CFG)" !=\
 "StagedConnect - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "StagedConnect.mak" CFG="StagedConnect - Win32 Debug"
!MESSAGE 
...
ALL : "$(OUTDIR)\StagedConnect.exe"

CLEAN : 
	-@erase "$(INTDIR)\dpconnect.obj"
	-@erase "$(INTDIR)\dpstage.obj"
	-@erase "$(INTDIR)\winmain.obj"
	-@erase "$(INTDIR)\winmain.res"
	-@erase "$(OUTDIR)\StagedConnect.exe"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/StagedConnect.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/StagedConnect.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/StagedConnect.pdb" /machine:I386\
 /out:"$(OUTDIR)/StagedConnect.exe" 
LINK32_OBJS= \
...
"$(OUTDIR)\StagedConnect.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(INTDIR)\winmain.res"
	-@erase "$(OUTDIR)\StagedConnect.exe"
	-@erase "$(OUTDIR)\StagedConnect.ilk"
	-@erase "$(OUTDIR)\StagedConnect.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/StagedConnect.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/StagedConnect.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/StagedConnect.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dpconnect.obj" \
	"$(INTDIR)\dpstage.obj" \
...
"$(INTDIR)\dpstage.obj" : $(SOURCE) "$(INTDIR)"
