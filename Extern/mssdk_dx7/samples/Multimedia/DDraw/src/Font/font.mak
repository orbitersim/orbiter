...
!MESSAGE No configuration specified.  Defaulting to font - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "font - Win32 Release" && "$(CFG)" != "font - Win32 Debug"
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "font - Win32 Debug"
RSC=rc.exe
MTL=mktyplib.exe
CPP=cl.exe
...
CLEAN : 
	...
	-@erase "$(INTDIR)\font.res"
	-@erase "$(OUTDIR)\font.exe"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/font.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)/font.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/font.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=dxguid.lib ddraw.lib kernel32.lib user32.lib gdi32.lib\
 ...
 /pdb:"$(OUTDIR)/font.pdb" /machine:I386 /out:"$(OUTDIR)/font.exe" 
LINK32_OBJS= \
	"$(INTDIR)\font.obj" \
	"$(INTDIR)\font.res"

"$(OUTDIR)\font.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\font.exe"
	-@erase "$(OUTDIR)\font.ilk"
	-@erase "$(OUTDIR)\font.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/font.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)/font.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/font.bsc" 
...
LINK32_FLAGS=dxguid.lib ddraw.lib kernel32.lib user32.lib gdi32.lib\
 ...
 /pdb:"$(OUTDIR)/font.pdb" /debug /machine:I386 /out:"$(OUTDIR)/font.exe" 
LINK32_OBJS= \
	"$(INTDIR)\font.obj" \
	"$(INTDIR)\font.res"
...
"$(INTDIR)\font.res" : $(SOURCE) $(DEP_RSC_FONT_R) "$(INTDIR)"
   $(RSC) $(RSC_PROJ) $(SOURCE)
