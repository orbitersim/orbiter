...
!MESSAGE No configuration specified.  Defaulting to scrawl - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "scrawl - Win32 Release" && "$(CFG)" != "scrawl - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "scrawl.mak" CFG="scrawl - Win32 Debug"
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "scrawl - Win32 Debug"
CPP=cl.exe
RSC=rc.exe
MTL=mktyplib.exe
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/scrawl.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
LINK32_FLAGS=dinput.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/scrawl.pdb" /machine:I386 /out:"$(OUTDIR)/scrawl.exe" 
LINK32_OBJS= \
	"$(INTDIR)\scrawl.obj" \
	"$(INTDIR)\scrawl.res" \
	"$(INTDIR)\WinMain.obj"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/scrawl.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=dinput.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/scrawl.pdb" /debug /machine:I386 /out:"$(OUTDIR)/scrawl.exe" 
LINK32_OBJS= \
	"$(INTDIR)\scrawl.obj" \
	"$(INTDIR)\scrawl.res" \
	"$(INTDIR)\WinMain.obj"
...
"$(INTDIR)\scrawl.obj" : $(SOURCE) $(DEP_CPP_SCRAW) "$(INTDIR)"
...
"$(INTDIR)\scrawl.res" : $(SOURCE) $(DEP_RSC_SCRAWL) "$(INTDIR)"
   $(RSC) $(RSC_PROJ) $(SOURCE)
