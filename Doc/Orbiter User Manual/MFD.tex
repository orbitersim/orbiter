...
Note that Orbiter now contains Duncan Sharpe's TransX MFD mode as a plug-in module, which supersedes and extends most of the Transfer MFD functionality (see \ref{ssec:mfd_transx}).\\
\\
\textbf{Key options:}
