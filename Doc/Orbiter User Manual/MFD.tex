...
\item Collision detection is now performed between vessels based on their surface meshes. If you fail to dock and impact the station, the collision will be resolved according to rigid-body physics, potentially damaging your vessel or knocking both objects out of their current state.
\end{itemize}
