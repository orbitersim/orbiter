...
%TODO update tech ref and mention dev manual
%TODO confirm websites work
...
If you are a first-time user, it is probably a good idea to have a look at this manual to get you off the ground quickly. Ideally, use it together with the simulator. If you don't want to print it, run Orbiter in window mode (see Section TODO) and have the manual open next to it.\\
%TODO add section link
For installation help, see Section TODO. The first time you run Orbiter, you will have to configure the video options (Sec. TODO). Then you are good to go - see Sec. TODO on how to select a scenario and launch the simulation.\\
...
%TODO add section link
Once you are ready to take control, have a look at the Quickstart chapter (Sec. TODO). It contains step-by-step instructions for take-off, flight and landing in the futuristic Delta-glider.\\
%TODO add section link
Some more complex missions, including a flight from Kennedy Space Center to the International Space Station, can be found in the Flight checklists folder (Sec. TODO).\\
%TODO add section link
For an overview of basic spacecraft controls, see Sec. TODO. A detailed list of common keyboard commands can be found in Sec. TODO.\\
