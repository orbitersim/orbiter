...
\item \textbf{options:} Open the Options dialog which allows to configure functional and visual simulation parameters, such as MFD parameters, joystick settings, celestial sphere background rendering settings, or "Visual helpers" (see \ref{ssec:menu_options}). Keyboard shortcut: \keystroke{F6}.
