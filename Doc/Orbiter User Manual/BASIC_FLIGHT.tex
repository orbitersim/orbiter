...
In terms of the orbital elements, aligning the plane of the orbit with the target plane means to match the two elements which define the orientation of the orbit in space (see section \ref{ssec:sol_orb_mech}): inclination (\textit{i}) and longitude of the ascending node ($\Omega$).\\
