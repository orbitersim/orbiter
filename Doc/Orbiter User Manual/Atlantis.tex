...
\begin{figure}[H]
	\centering
	\subfigure{\includegraphics[width=0.75\textwidth]{atlantis.png}}
...
\item Set the PL BAY DOOR SYS 1 and SYS 2 switches to DISABLE.
\end{itemize}
%TODO (Ref: Operations Manual Sec. 2.17)
...
\item Set both PL BAY MECH PWR switches back to OFF.
\end{itemize}
%TODO (Ref: Operations Manual Sec. 2.9)
...
\end{itemize}
%TODO (Ref: Operations Manual Sec. 2.4)
