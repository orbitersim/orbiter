...
%\begin{table}[H]
	...
	\hline\rule{0pt}{2ex}
	MarkerPath & String & Directory path containing celestial marker lists for the planetary system. Default: .\textbackslash Config\textbackslash <\textit{Solsys-name}>\textbackslash Marker\textbackslash \\
	\hline
	\end{longtable}
%\end{table}
