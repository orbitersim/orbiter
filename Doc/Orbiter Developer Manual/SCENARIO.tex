...
Contains a short description of the scenario which is presented to the user in Orbiter's Launchpad dialog window on highlighting the scenario.
...
\noindent
where <\textit{Markdown-description}> contains a scenario description in CommonMark Markdown format. The description can span multiple lines. Images are referenced as paths relative to the Orbiter root directory, and cannot be URLs.
