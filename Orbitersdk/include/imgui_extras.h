...
namespace ImGui {
	...
	OAPIFUNC bool SliderScalarReset(const char* label, ImGuiDataType dtype, size_t t_size, void* v, const void *v_min, const void *v_max, const void *v_default, const char* display_format = "%.3f");
