...
public:
	 ...
	 * \sa GetTouchdownPointCount, SetTouchdownPoints(const TOUCHDOWNVTX*,uint32_t)const
	 */
	bool GetTouchdownPoint (TOUCHDOWNVTX &tdvtx, uint32_t idx) const;
	 ...
	 */
	void SetTouchdownPoints (const TOUCHDOWNVTX *tdvtx, uint32_t ntdvtx) const;
	 ...
	 */
	uint32_t GetTouchdownPointCount () const;
	 ...
	 */
	uint32_t GetFlightStatus () const;
	 ...
	 *   GetControlSurfaceLevel, SetControlSurfaceLevel
	 */
	void SetADCtrlMode (uint32_t mode) const;
	 ...
	 */
	void EditAirfoil (AIRFOILHANDLE hAirfoil, uint32_t flag, const VECTOR3 &ref, AirfoilCoeffFunc cf, double c, double S, double A) const;
	 ...
	 */
	uint32_t GetPropellantCount () const;
	 ...
	 */
	PROPELLANT_HANDLE GetPropellantHandleByIndex (uint32_t idx) const;
	 ...
	 */
	uint32_t GetThrusterCount () const;
	 ...
	 */
	THRUSTER_HANDLE GetThrusterHandleByIndex (uint32_t idx) const;
	 ...
	 */
	THGROUP_HANDLE GetUserThrusterGroupHandleByIndex (uint32_t idx) const;
	 ...
	 */
	uint32_t GetGroupThrusterCount (THGROUP_HANDLE thg) const;
	 ...
	 */
	uint32_t GetGroupThrusterCount (THGROUP_TYPE thgt) const;
	 ...
	 */
	THRUSTER_HANDLE GetGroupThruster (THGROUP_HANDLE thg, uint32_t idx) const;
	 ...
	 *   THGROUP_USER. For user-defined groups, use GetGroupThruster(THGROUP_HANDLE,uint32_t)const.
	 */
	THRUSTER_HANDLE GetGroupThruster (THGROUP_TYPE thgt, uint32_t idx) const;
	 ...
	 */
	uint32_t GetUserThrusterGroupCount () const;
	 ...
	 *   nonzero values.
	 */
	double GetManualControlLevel (THGROUP_TYPE thgt, uint32_t mode = MANCTRL_ATTMODE, uint32_t device = MANCTRL_ANYDEVICE) const;
	//@}
	 ...
	 */
	int SendBufferedKey (uint32_t key, bool down=true, char *kstate=0);
	//@}
	 ...
	 * \sa GetNavCount
	 */
	void InitNavRadios (uint32_t nnav) const;
	 ...
	 */
	bool SetNavChannel (uint32_t n, uint32_t ch) const;
	 ...
	 */
	uint32_t GetNavChannel (uint32_t n) const;
	 ...
	 * \sa GetNavChannel
	 */
	float GetNavRecvFreq (uint32_t n) const;
	 ...
	 */
	bool SetTransponderChannel (uint32_t ch) const;
	 ...
	 */
	bool SetIDSChannel (DOCKHANDLE hDock, uint32_t ch) const;
	 ...
	 */
	NAVHANDLE GetNavSource (uint32_t n) const;
	//@}
	 ...
	 */
	int MeshModified (MESHHANDLE hMesh, unsigned int grp, uint32_t modflag);
	//@}
	...
	int Dock (DOCKHANDLE hSrc, DOCKHANDLE hTgt, uint32_t mode) const;
	 ...
	 *   AttachChild, DetachChild
	 */
	uint32_t AttachmentCount (bool toparent) const;
	 ...
	 *   AttachChild, DetachChild
	 */
	uint32_t GetAttachmentIndex (ATTACHMENTHANDLE attachment) const;
	 ...
	 *   AttachChild, DetachChild
	 */
	ATTACHMENTHANDLE GetAttachmentHandle (bool toparent, uint32_t i) const;
	 ...
	 */
	uint32_t GetExhaustCount () const;
	 ...
	 */
	const BEACONLIGHTSPEC *GetBeacon (uint32_t idx) const;
	//@}
	 ...
	 */
	uint32_t LightEmitterCount () const;
	 ...
	 */
	const LightEmitter *GetLightEmitter (uint32_t i) const;
	 ...
	 *   AddExhaust(THRUSTER_HANDLE,double,double,const VECTOR3&,const VECTOR3&,SURFHANDLE)const
	 */
	void SetExhaustScales (EXHAUSTTYPE exh, uint16_t id, double lscale, double wscale) const;
	...
	void   DelExhaustRef (EXHAUSTTYPE exh, uint16_t id) const;  // obsolete
	 ...
	 * \deprecated This method has been replaced by VESSEL::SetTouchdownPoints(const TOUCHDOWNVTX*,uint32_t)const
	 ...
	 *   SetTouchdownPoints(const TOUCHDOWNVTX*,uint32_t)const to define a convex hull of touchdown points.
	 ...
	 * \sa GetTouchdownPoints, GetCOG_elev, \ref SetTouchdownPoints(const TOUCHDOWNVTX*, uint32_t)const
	 *   SetEmptyMass
	 */
	 ...
	 * \deprecated This method has been replaced by VESSEL::GetTouchdownPoint(TOUCHDOWNVTX&,uint32_t)const
	 * \param pt1 touchdown point of nose wheel (or equivalent)
	 * \param pt2 touchdown point of left main wheel (or equivalent)
	 * \param pt3 touchdown point of right main wheel (or equivalent)
	 ...
	 *   (e.g. landing gear).
	 * \note This function is superseded by \ref GetTouchdownPoint(TOUCHDOWNVTX&,uint32_t)const, which
	 ...
	 */
	bool SetNavRecv (uint32_t n, uint32_t ch) const;
	 ...
	 *   return value is 0.
	 */
	uint32_t GetNavRecv (uint32_t n) const;
...
public:
	 ...
	 * \sa \ref progflow1
	 */
	virtual void clbkADCtrlMode (uint32_t mode);
	 ...
	 */
	virtual int clbkConsumeBufferedKey (uint32_t key, bool down, char *kstate);
...
public:
	 ...
	 */
	int SetPanelBackground (PANELHANDLE hPanel, SURFHANDLE *hSurf, uint32_t nsurf, MESHHANDLE hMesh, uint32_t width, uint32_t height, uint32_t baseline = 0, uint32_t scrollflag = 0);
	 ...
	 * \sa \ref progflow1
	 */
	virtual bool clbkLoadPanel2D (int id, PANELHANDLE hPanel, uint32_t viewW, uint32_t viewH);
