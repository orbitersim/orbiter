...
// ======================================================================
//@{
#define OAPI_KEY_ESCAPE			SDL_SCANCODE_ESCAPE  ///< Escape key
#define OAPI_KEY_1				SDL_SCANCODE_1  ///< '1' key on main keyboard
#define OAPI_KEY_2				SDL_SCANCODE_2  ///< '2' key on main keyboard
#define OAPI_KEY_3				SDL_SCANCODE_3  ///< '3' key on main keyboard
#define OAPI_KEY_4				SDL_SCANCODE_4  ///< '4' key on main keyboard
#define OAPI_KEY_5				SDL_SCANCODE_5  ///< '5' key on main keyboard
#define OAPI_KEY_6				SDL_SCANCODE_6  ///< '6' key on main keyboard
#define OAPI_KEY_7				SDL_SCANCODE_7  ///< '7' key on main keyboard
#define OAPI_KEY_8				SDL_SCANCODE_8  ///< '8' key on main keyboard
#define OAPI_KEY_9				SDL_SCANCODE_9  ///< '9' key on main keyboard
#define OAPI_KEY_0				SDL_SCANCODE_0  ///< '0' key on main keyboard
#define OAPI_KEY_MINUS			SDL_SCANCODE_MINUS  ///< '-' key on main keyboard
#define OAPI_KEY_EQUALS			SDL_SCANCODE_EQUALS  ///< '=' key on main keyboard
#define OAPI_KEY_BACK			SDL_SCANCODE_BACKSPACE  ///< backspace key
#define OAPI_KEY_TAB			SDL_SCANCODE_TAB  ///< tab key
#define OAPI_KEY_Q				SDL_SCANCODE_Q  ///< 'Q' key
#define OAPI_KEY_W				SDL_SCANCODE_W  ///< 'W' key
#define OAPI_KEY_E				SDL_SCANCODE_E  ///< 'E' key
#define OAPI_KEY_R				SDL_SCANCODE_R  ///< 'R' key
#define OAPI_KEY_T				SDL_SCANCODE_T  ///< 'T' key
#define OAPI_KEY_Y				SDL_SCANCODE_Y  ///< 'Y' key
#define OAPI_KEY_U				SDL_SCANCODE_U  ///< 'U' key
#define OAPI_KEY_I				SDL_SCANCODE_I  ///< 'I' key
#define OAPI_KEY_O				SDL_SCANCODE_O  ///< 'O' key
#define OAPI_KEY_P				SDL_SCANCODE_P  ///< 'P' key
#define OAPI_KEY_LBRACKET		SDL_SCANCODE_LEFTBRACKET  ///< '[' (left bracket) key
#define OAPI_KEY_RBRACKET		SDL_SCANCODE_RIGHTBRACKET  ///< ']' (right bracket) key
#define OAPI_KEY_RETURN			SDL_SCANCODE_RETURN  ///< 'Enter' key on main keyboard
#define OAPI_KEY_LCONTROL		SDL_SCANCODE_LCTRL  ///< Left 'Ctrl' key
#define OAPI_KEY_A				SDL_SCANCODE_A  ///< 'A' key
#define OAPI_KEY_S				SDL_SCANCODE_S  ///< 'S' key
#define OAPI_KEY_D				SDL_SCANCODE_D  ///< 'D' key
#define OAPI_KEY_F				SDL_SCANCODE_F  ///< 'F' key
#define OAPI_KEY_G				SDL_SCANCODE_G  ///< 'G' key
#define OAPI_KEY_H				SDL_SCANCODE_H  ///< 'H' key
#define OAPI_KEY_J				SDL_SCANCODE_J  ///< 'J' key
#define OAPI_KEY_K				SDL_SCANCODE_K  ///< 'K' key
#define OAPI_KEY_L				SDL_SCANCODE_L  ///< 'L' key
#define OAPI_KEY_SEMICOLON		SDL_SCANCODE_SEMICOLON  ///< ';' (semicolon) key
#define OAPI_KEY_APOSTROPHE		SDL_SCANCODE_APOSTROPHE  ///< ' (apostrophe) key
#define OAPI_KEY_GRAVE			SDL_SCANCODE_GRAVE  ///< accent grave
#define OAPI_KEY_LSHIFT			SDL_SCANCODE_LSHIFT  ///< Left 'Shift' key
#define OAPI_KEY_BACKSLASH		SDL_SCANCODE_BACKSLASH  ///< '\' (Backslash) key
#define OAPI_KEY_Z				SDL_SCANCODE_Z  ///< 'Z' key
#define OAPI_KEY_X				SDL_SCANCODE_X  ///< 'X' key
#define OAPI_KEY_C				SDL_SCANCODE_C  ///< 'C' key
#define OAPI_KEY_V				SDL_SCANCODE_V  ///< 'V' key
#define OAPI_KEY_B				SDL_SCANCODE_B  ///< 'B' key
#define OAPI_KEY_N				SDL_SCANCODE_N  ///< 'N' key
#define OAPI_KEY_M				SDL_SCANCODE_M  ///< 'M' key
#define OAPI_KEY_COMMA			SDL_SCANCODE_COMMA  ///< ',' (comma) key
#define OAPI_KEY_PERIOD			SDL_SCANCODE_PERIOD  ///< '.' key on main keyboard
#define OAPI_KEY_SLASH			SDL_SCANCODE_SLASH  ///< '/' key on main keyboard
#define OAPI_KEY_RSHIFT			SDL_SCANCODE_RSHIFT  ///< Right 'Shift' key
#define OAPI_KEY_MULTIPLY		SDL_SCANCODE_KP_MULTIPLY  ///< * on numeric keypad
#define OAPI_KEY_LALT			SDL_SCANCODE_LALT  ///< left Alt
#define OAPI_KEY_SPACE			SDL_SCANCODE_SPACE  ///< 'Space' key
#define OAPI_KEY_CAPITAL		SDL_SCANCODE_CAPSLOCK  ///< caps lock key
#define OAPI_KEY_F1				SDL_SCANCODE_F1  ///< F1 function key
#define OAPI_KEY_F2				SDL_SCANCODE_F2  ///< F2 function key
#define OAPI_KEY_F3				SDL_SCANCODE_F3  ///< F3 function key
#define OAPI_KEY_F4				SDL_SCANCODE_F4  ///< F4 function key
#define OAPI_KEY_F5				SDL_SCANCODE_F5  ///< F5 function key
#define OAPI_KEY_F6				SDL_SCANCODE_F6  ///< F6 function key
#define OAPI_KEY_F7				SDL_SCANCODE_F7  ///< F7 function key
#define OAPI_KEY_F8				SDL_SCANCODE_F8  ///< F8 function key
#define OAPI_KEY_F9				SDL_SCANCODE_F9  ///< F9 function key
#define OAPI_KEY_F10			SDL_SCANCODE_F10  ///< F10 function key
#define OAPI_KEY_NUMLOCK		SDL_SCANCODE_NUMLOCKCLEAR  ///< 'Num Lock' key
#define OAPI_KEY_SCROLL			SDL_SCANCODE_SCROLLLOCK  ///< Scroll lock
#define OAPI_KEY_NUMPAD7		SDL_SCANCODE_KP_7  ///< '7' key on numeric keypad
#define OAPI_KEY_NUMPAD8		SDL_SCANCODE_KP_8  ///< '8' key on numeric keypad
#define OAPI_KEY_NUMPAD9		SDL_SCANCODE_KP_9  ///< '9' key on numeric keypad
#define OAPI_KEY_SUBTRACT		SDL_SCANCODE_KP_MINUS  ///< '-' key on numeric keypad
#define OAPI_KEY_NUMPAD4		SDL_SCANCODE_KP_4  ///< '4' key on numeric keypad
#define OAPI_KEY_NUMPAD5		SDL_SCANCODE_KP_5  ///< '5' key on numeric keypad
#define OAPI_KEY_NUMPAD6		SDL_SCANCODE_KP_6  ///< '6' key on numeric keypad
#define OAPI_KEY_ADD			SDL_SCANCODE_KP_PLUS  ///< '+' key on numeric keypad
#define OAPI_KEY_NUMPAD1		SDL_SCANCODE_KP_1  ///< '1' key on numeric keypad
#define OAPI_KEY_NUMPAD2		SDL_SCANCODE_KP_2  ///< '2' key on numeric keypad
#define OAPI_KEY_NUMPAD3		SDL_SCANCODE_KP_3  ///< '3' key on numeric keypad
#define OAPI_KEY_NUMPAD0		SDL_SCANCODE_KP_0  ///< '0' key on numeric keypad
#define OAPI_KEY_DECIMAL		SDL_SCANCODE_KP_DECIMAL  ///< '.' key on numeric keypad
#define OAPI_KEY_OEM_102		SDL_SCANCODE_NONUSBACKSLASH  ///< | \< \> on UK/German keyboards
#define OAPI_KEY_F11			SDL_SCANCODE_F11  ///< F11 function key
#define OAPI_KEY_F12			SDL_SCANCODE_F12  ///< F12 function key
#define OAPI_KEY_NUMPADENTER	SDL_SCANCODE_KP_ENTER  ///< Enter on numeric keypad
#define OAPI_KEY_RCONTROL		SDL_SCANCODE_RCTRL  ///< right Control key
#define OAPI_KEY_DIVIDE			SDL_SCANCODE_KP_DIVIDE  ///< '/' key on numeric keypad
#define OAPI_KEY_SYSRQ          SDL_SCANCODE_PRINTSCREEN  ///< SysRq/PrtScn key
#define OAPI_KEY_RALT           SDL_SCANCODE_RALT  ///< right Alt
#define OAPI_KEY_PAUSE          SDL_SCANCODE_PAUSE  ///< Break/Pause key
#define OAPI_KEY_HOME           SDL_SCANCODE_HOME  ///< Home on cursor keypad
#define OAPI_KEY_UP             SDL_SCANCODE_UP  ///< up-arrow on cursor keypad
#define OAPI_KEY_PRIOR          SDL_SCANCODE_PAGEUP  ///< PgUp on cursor keypad
#define OAPI_KEY_LEFT           SDL_SCANCODE_LEFT  ///< left-arrow on cursor keypad
#define OAPI_KEY_RIGHT          SDL_SCANCODE_RIGHT  ///< right-arrow on cursor keypad
#define OAPI_KEY_END            SDL_SCANCODE_END  ///< End on cursor keypad
#define OAPI_KEY_DOWN           SDL_SCANCODE_DOWN  ///< down-arrow on cursor keypad
#define OAPI_KEY_NEXT           SDL_SCANCODE_PAGEDOWN  ///< PgDn on cursor keypad
#define OAPI_KEY_INSERT         SDL_SCANCODE_INSERT  ///< Insert on cursor keypad
#define OAPI_KEY_DELETE         SDL_SCANCODE_DELETE  ///< Delete on cursor keypad
//@}
