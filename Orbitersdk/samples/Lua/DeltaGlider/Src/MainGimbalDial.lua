...
-- ==============================================================
--               ORBITER MODULE: MainGimbalDial.lua
...
local MainGimbalDial = Class(DGDial1)

function MainGimbalDial:new (gc)
	DGDial1.new(self, gc:DG(), 3, -50*RAD, 50*RAD)
	self.ctrl = gc
end

--------------------------------------------------------------

function MainGimbalDial:Reset2D (panelid, hMesh)
...
function MainGimbalDial:ResetVC (hMesh)
...
function MainGimbalDial:Redraw2D (surf)
...
function MainGimbalDial:ProcessMouse2D (event, mx, my)
	local mode = self.ctrl:Mode()
...
function MainGimbalDial:ProcessMouseVC (event, p)
