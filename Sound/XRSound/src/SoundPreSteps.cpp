    ...
    DefaultSoundPreStep(pEngine)
{
    ...
    m_pRCSAttackForAxisSoundArray[0]  = new RCSAttackForAxisSound(m_thrustVectorsROT.x, XRSound::RCSAttackPlusX, pEngine, false, config.RCSAttackPlusX.c_str());
    m_pRCSAttackForAxisSoundArray[1]  = new RCSAttackForAxisSound(m_thrustVectorsLIN.x, XRSound::RCSAttackPlusX, pEngine, false, config.RCSAttackPlusX.c_str());
    m_pRCSAttackForAxisSoundArray[2]  = new RCSAttackForAxisSound(m_thrustVectorsROT.y, XRSound::RCSAttackPlusY, pEngine, false, config.RCSAttackPlusY.c_str());
    m_pRCSAttackForAxisSoundArray[3]  = new RCSAttackForAxisSound(m_thrustVectorsLIN.y, XRSound::RCSAttackPlusY, pEngine, false, config.RCSAttackPlusY.c_str());
    m_pRCSAttackForAxisSoundArray[4]  = new RCSAttackForAxisSound(m_thrustVectorsROT.z, XRSound::RCSAttackPlusZ, pEngine, false, config.RCSAttackPlusZ.c_str());
    m_pRCSAttackForAxisSoundArray[5]  = new RCSAttackForAxisSound(m_thrustVectorsLIN.z, XRSound::RCSAttackPlusZ, pEngine, false, config.RCSAttackPlusZ.c_str());

    m_pRCSAttackForAxisSoundArray[6]  = new RCSAttackForAxisSound(m_thrustVectorsROT.x, XRSound::RCSAttackMinusX, pEngine, true, config.RCSAttackMinusX.c_str());
    m_pRCSAttackForAxisSoundArray[7]  = new RCSAttackForAxisSound(m_thrustVectorsLIN.x, XRSound::RCSAttackMinusX, pEngine, true, config.RCSAttackMinusX.c_str());
    m_pRCSAttackForAxisSoundArray[8]  = new RCSAttackForAxisSound(m_thrustVectorsROT.y, XRSound::RCSAttackMinusY, pEngine, true, config.RCSAttackMinusY.c_str());
    m_pRCSAttackForAxisSoundArray[9]  = new RCSAttackForAxisSound(m_thrustVectorsLIN.y, XRSound::RCSAttackMinusY, pEngine, true, config.RCSAttackMinusY.c_str());
    m_pRCSAttackForAxisSoundArray[10] = new RCSAttackForAxisSound(m_thrustVectorsROT.z, XRSound::RCSAttackMinusZ, pEngine, true, config.RCSAttackMinusZ.c_str());
    m_pRCSAttackForAxisSoundArray[11] = new RCSAttackForAxisSound(m_thrustVectorsLIN.z, XRSound::RCSAttackMinusZ, pEngine, true, config.RCSAttackMinusZ.c_str());
}
