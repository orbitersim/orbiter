...
{
    D3D7Enum_DeviceInfo* pDevice = (D3D7Enum_DeviceInfo*)pParentInfo;
                                          ...
                                          D3DDEVICEDESC7* pDesc, VOID* pParentInfo)
{
    ...
    D3D7Enum_DeviceInfo* pDeviceInfo = &g_pDeviceList[g_dwNumDevices];  // every time we're called, point to the next structure in the array.
...
int D3D7Enum_ReadDeviceList (CHAR *fname)
{
	...
	for (i = 0; i < 20; i++) {
		...
		pInfo->pddsdModes = new DDSURFACEDESC2[pInfo->dwNumModes];
