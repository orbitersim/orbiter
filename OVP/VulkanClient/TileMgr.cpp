...
TileManager::TileManager (vkClient *gclient, const vPlanet *vplanet) : vkEffect()
{
	vp = vplanet;
	obj = vp->Object();
	char name[256];
...
void TileManager::GlobalInit (vkClient *gclient)
{
...
TileBuffer::TileBuffer (const oapi::vkClient *gclient)
	: gc(gclient)
	, nbuf(0)
	, nused(0)
	, last(0)
