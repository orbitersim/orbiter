...
// ===============================================================================================
//
void vkPad::GetRenderSurfaceSize(LPSIZE size)
{
...
// ===============================================================================================
//
void vkPad::QuickPen(DWORD color, float width, DWORD style)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::QuickBrush(DWORD color)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
RECT vkPad::GetFullRect(SURFHANDLE hSrc)
{
...
// ===============================================================================================
//
void vkPad::CopyRect(const SURFHANDLE hSrc, const LPRECT _s, int tx, int ty)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::StretchRect(const SURFHANDLE hSrc, const LPRECT _s, const LPRECT _t)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::RotateRect(const SURFHANDLE hSrc, const LPRECT _s, int tcx, int tcy, float angle, float sw, float sh)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::ColorKey(const SURFHANDLE hSrc, const LPRECT _s, int tx, int ty)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::ColorKeyStretch(const SURFHANDLE hSrc, const LPRECT _s, const LPRECT _t)
{
#ifdef SKPDBG 
	Log("StretchRect(0x%X)", DWORD(hSrc));
#endif
...
// ===============================================================================================
//
void vkPad::CopyRectNative(const LPDIRECT3DTEXTURE9 pSrc, const LPRECT _s, int tx, int ty)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::StretchRectNative(const LPDIRECT3DTEXTURE9 pSrc, const RECT *_s, const RECT *_t)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::CopyTetragon(const SURFHANDLE hSrc, const LPRECT _s, const FVECTOR2 tp[4])
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::FillTetragon(DWORD c, const FVECTOR2 pt[4])
{
#ifdef SKPDBG 
	Log("CopyTetragon(0x%X)", DWORD(pSrc));
#endif
...
// ===============================================================================================
//
bool vkPad::TextW (int x, int y, const LPWSTR str, int len)
{
#ifdef SKPDBG 
	Log("TextW()");
#endif
	...
	vkTextPtr pText = static_cast<const vkPadFont *>(cfont)->pFont;
...
// ===============================================================================================
//
void vkPad::TextEx(float x, float y, const char *str, float scale, float angle)
{
#ifdef SKPDBG 
	Log("TextEx()");
#endif
...
// ===============================================================================================
//
void vkPad::ClipRect(const LPRECT clip)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::Clipper(int idx, const VECTOR3 *uDir, double cos_angle, double dist)
{
#ifdef SKPDBG 
	Log("Clipper()");
#endif
...
// ===============================================================================================
//
void vkPad::DepthEnable(bool bEnable)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
const FMATRIX4 *vkPad::ViewMatrix() const
{
...
// ===============================================================================================
//
const FMATRIX4 *vkPad::ProjectionMatrix() const
{
...
// ===============================================================================================
//
const FMATRIX4 *vkPad::GetViewProjectionMatrix() const
{
...
// ===============================================================================================
//
void vkPad::SetViewMatrix(const FMATRIX4 *pV)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::SetProjectionMatrix(const FMATRIX4 *pP)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::SetViewMode(SkpView mode)
{
#ifdef SKPDBG 
...
// ===============================================================================================
// !! For a private use in vkClient !!
//
FMATRIX4* vkPad::WorldMatrix()
{
#ifdef SKPDBG 
	Log("WorldMatrix() ! - ! - !");
#endif
...
// ===============================================================================================
//
void vkPad::SetWorldTransform2D(float scale, float rot, const IVECTOR2 *c, const IVECTOR2 *t)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::SetWorldTransform(const FMATRIX4 *pWT)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::SetWorldBillboard(const FVECTOR3& wpos, float scale, bool bFixed, const FVECTOR3* index)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::SetGlobalLineScale(float width, float pat)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
void vkPad::SetFontTextureNative(LPDIRECT3DTEXTURE9 hNew)
{
...
// ===============================================================================================
//
bool vkPad::TexChangeNative(LPDIRECT3DTEXTURE9 hNew)
{
...
// ===============================================================================================
//
void vkPad::TexChange(SURFHANDLE hNew)
{
...
// ===============================================================================================
//
int vkPad::DrawMeshGroup(const MESHHANDLE hMesh, DWORD grp, Sketchpad::MeshFlags flags, const SURFHANDLE hTex)
{
#ifdef SKPDBG 
...
// ===============================================================================================
//
RECT vkPad::GetFullRectNative(LPDIRECT3DTEXTURE9 hSrc)
{
...
vkPolyLine::vkPolyLine(LPDIRECT3DDEVICE9 pDev, const FVECTOR2 *pt, int npt, bool bConnect) : vkPolyBase(0)
{
	nPt = npt + 2;
	nVtx = 2 * nPt;
	nIdx = 6 * nPt;
...
// ===============================================================================================
//
void vkPolyLine::Draw(vkPad *pSkp, LPDIRECT3DDEVICE9 pDev)
{
...
// ===============================================================================================
//
void vkPolyLine::Update(const FVECTOR2 *_pt, int _npt, bool bConnect)
{
	SkpVtx *Vtx = NULL;
...
vkTriangle::vkTriangle(LPDIRECT3DDEVICE9 pDev, const gcCore::clrVtx *pt, int npt, int _style) : vkPolyBase(1)
{
	nPt = npt;
	style = _style;
...
// ===============================================================================================
//
void vkTriangle::Draw(vkPad* pSkp, LPDIRECT3DDEVICE9 pDev)
{
	pDev->SetStreamSource(0, pVB, 0, sizeof(SkpVtx));
...
// ===============================================================================================
//
void vkTriangle::Update(const gcCore::clrVtx *pt, int npt)
{
	SkpVtx *Vtx = NULL;
	HR(pVB->Lock(0, 0, (LPVOID*)&Vtx, D3DLOCK_DISCARD));
