...
#ifndef __vkCELSPHERE_H
#define __vkCELSPHERE_H
 ...
 * labels, etc.)
 */
class vkCelestialSphere : public oapi::CelestialSphere {
...
public:
	 ...
	 */
	explicit vkCelestialSphere(oapi::vkClient *gc, Scene* scene);
	...
	static void vkTechInit(ID3DXEffect* fx);
...
private:
	oapi::vkClient *m_gc;         ///< pointer to graphics client
