...
class vkLight : public LightStruct
{
public:
				vkLight();
				vkLight(const LightEmitter *le, const class vObject *vo);
				~vkLight();
...
#define vkMATEX_DIFFUSE		0x001
#define vkMATEX_AMBIENT		0x002
#define vkMATEX_SPECULAR		0x004
#define vkMATEX_EMISSIVE		0x008
#define vkMATEX_REFLECT		0x010
#define vkMATEX_FRESNEL		0x040
#define vkMATEX_ROUGHNESS		0x080
#define vkMATEX_EMISSION2		0x100
#define vkMATEX_METALNESS		0x200
#define vkMATEX_SPECIALFX		0x400


/**
 * \brief Material structure used in vkMesh. ModFlags is not loaded to shaders
 */
typedef struct {
	FVECTOR4	Diffuse;
...
typedef struct {
	class vkMesh *pMesh;			///< Mesh handle
...
inline void LogSunLight(vkSun& s)
{
