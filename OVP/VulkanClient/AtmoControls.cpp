...
void Create()
{
	...
	dwCmd = oapiRegisterCustomCmd((char*)"vk Atmospheric Controls", (char*)"This dialog allows to control various atmospheric parameters and effects", OpenDlgClbk, NULL);
...
{
	HWND l_hDlg = oapiOpenDialog(g_hInst, IDD_vkSCATTER, WndProc);
