...
//				 2011 - 2106 Jarmo Nikkanen (vkClient modification)  
// ==============================================================
...
void RingManager::GlobalInit(vkClient *gclient)
{
	gc = gclient;
}
...
vkMesh *RingManager::CreateRing(double irad, double orad, int nsect)
{
	int i, j;
	...
	vkMesh *msh = new vkMesh(grp, &mat, NULL);
...
oapi::vkClient *RingManager::gc = 0;
