...
public:
	...
	vkPick Pick(const FVECTOR3 *vDir, const PickProp* p);
...
protected:
	 ...
	 * \param light pointer to vkLight structure receiving modified parameters
...
private:
	...
	struct MESHREC {
		vkMesh *mesh;		// DX9 mesh representation
