...
class vkParticleStream : public oapi::ParticleStream, public vkEffect
{
...
public:
	 ...
	 */
	vkParticleStream (oapi::GraphicsClient *_gc, PARTICLESTREAMSPEC *pss = 0);

	/**
	 * \brief Destroys the particle stream object
	 */
	virtual ~vkParticleStream();
...
protected:
	oapi::vkClient *pGC;					// pointer to graphics client
...
class ExhaustStream: public vkParticleStream {
public:
...
class ReentryStream: public vkParticleStream {
public:
