...
public:
	...
	static void		GlobalInit(oapi::vkClient* gc);
	static void		GlobalInitAtmosphere(oapi::vkClient* gc);
	...
	void            RenderVectors (LPDIRECT3DDEVICE9 dev, vkPad* pSkp);
	...
	vkSun			GetObjectAtmoParams(VECTOR3 relpos);
	...
	void            RenderLabels(LPDIRECT3DDEVICE9 dev, vkPad *skp, oapi::Font **labelfont, int *fontidx);
...
private:
	...
	vkMesh *mesh;           // mesh for non-spherical body
