...
// Copyright (C) 2011 - 2016 Jarmo Nikkanen (vkClient modification) 
// ==============================================================
...
const vkConfig *CSphereManager::cfg = NULL;
...
CSphereManager::CSphereManager(vkClient *gc, const Scene *scene) : gc(gc), texname(), RenderParam()
{
	scn = scene;
	...
	pShader = new ShaderClass(gc->GetDevice(), "Modules/vkShaders/CelSphere.hlsl", "CelVS", "CelPS", "CelSphere", "");
...
void CSphereManager::GlobalInit(oapi::vkClient *gclient)
{
