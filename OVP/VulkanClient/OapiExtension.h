...
public:
	 ...
	 * vkConfig::DisableVisualHelperReadout value.
	 * \param Config A reference to the configuration class, to get the \ref
	 *   vkConfig::DisableVisualHelperReadout value.
	 */
	static void GlobalInit(const vkConfig &Config);
...
private:
	...
	static void LogvkModules(void);   ///< Logs loaded vk DLLs and their versions
