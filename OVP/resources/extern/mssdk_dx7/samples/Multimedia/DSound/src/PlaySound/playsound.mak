...
!IF "$(CFG)" != "PlaySound - Win32 Release" && "$(CFG)" !=\
 "PlaySound - Win32 Debug"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/PlaySound.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
LINK32_FLAGS=dsound.lib dxguid.lib winmm.lib comctl32.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/PlaySound.pdb" /machine:I386 /out:"$(OUTDIR)/PlaySound.exe" 
LINK32_OBJS= \
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/PlaySound.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=dsound.lib dxguid.lib winmm.lib comctl32.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/PlaySound.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/PlaySound.exe" 
LINK32_OBJS= \
	"$(INTDIR)\playsound.obj" \
	"$(INTDIR)\wavread.obj" \
	"$(INTDIR)\winmain.obj" \
...
"$(INTDIR)\playsound.obj" : $(SOURCE) $(DEP_CPP_PLAYS) "$(INTDIR)"
