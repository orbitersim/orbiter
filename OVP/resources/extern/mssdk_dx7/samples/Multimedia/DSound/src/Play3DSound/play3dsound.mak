...
!IF "$(CFG)" != "Play3DSound - Win32 Release" && "$(CFG)" !=\
 "Play3DSound - Win32 Debug"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/Play3DSound.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD LINK32 dsound.lib winmm.lib dxguid.lib comctl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /machine:I386
LINK32_FLAGS=dsound.lib winmm.lib dxguid.lib comctl32.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/Play3DSound.pdb" /machine:I386 /out:"$(OUTDIR)/Play3DSound.exe"\
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/Play3DSound.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
# ADD LINK32 dsound.lib winmm.lib dxguid.lib comctl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /debug /machine:I386
LINK32_FLAGS=dsound.lib winmm.lib dxguid.lib comctl32.lib kernel32.lib\
 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib\
 ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /incremental:yes\
 /pdb:"$(OUTDIR)/Play3DSound.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/Play3DSound.exe" 
LINK32_OBJS= \
	"$(INTDIR)\play3dsound.obj" \
	"$(INTDIR)\wavread.obj" \
	"$(INTDIR)\winmain.obj" \
...
"$(INTDIR)\play3dsound.obj" : $(SOURCE) $(DEP_CPP_PLAY3) "$(INTDIR)"
