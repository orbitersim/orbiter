...
!MESSAGE No configuration specified.  Defaulting to ddex3 - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "ddex3 - Win32 Release" && "$(CFG)" != "ddex3 - Win32 Debug"
...
!MESSAGE 
!MESSAGE "ddex3 - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "ddex3 - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "ddex3 - Win32 Debug"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe
...
ALL : "$(OUTDIR)\ddex3.exe"

CLEAN : 
	-@erase "$(INTDIR)\ddex3.obj"
	-@erase "$(INTDIR)\ddex3.res"
	-@erase "$(INTDIR)\ddutil.obj"
	-@erase "$(OUTDIR)\ddex3.exe"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/ddex3.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)/ddex3.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/ddex3.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=dxguid.lib ddraw.lib kernel32.lib user32.lib gdi32.lib\
 ...
 /pdb:"$(OUTDIR)/ddex3.pdb" /machine:I386 /out:"$(OUTDIR)/ddex3.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ddex3.obj" \
	"$(INTDIR)\ddex3.res" \
	"$(INTDIR)\ddutil.obj"

"$(OUTDIR)\ddex3.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\ddex3.exe"
	-@erase "$(OUTDIR)\ddex3.ilk"
	-@erase "$(OUTDIR)\ddex3.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/ddex3.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)/ddex3.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/ddex3.bsc" 
...
LINK32_FLAGS=dxguid.lib ddraw.lib kernel32.lib user32.lib gdi32.lib\
 ...
 /pdb:"$(OUTDIR)/ddex3.pdb" /debug /machine:I386 /out:"$(OUTDIR)/ddex3.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ddex3.obj" \
	"$(INTDIR)\ddex3.res" \
	"$(INTDIR)\ddutil.obj"
...
"$(INTDIR)\ddex3.obj" : $(SOURCE) $(DEP_CPP_DDEX3) "$(INTDIR)"
...
"$(INTDIR)\ddex3.res" : $(SOURCE) $(DEP_RSC_DDEX3_) "$(INTDIR)"
   $(RSC) $(RSC_PROJ) $(SOURCE)
