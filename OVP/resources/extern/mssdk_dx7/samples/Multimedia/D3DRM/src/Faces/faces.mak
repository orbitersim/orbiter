...
!IF "$(CFG)" == ""
CFG=faces - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to faces - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "faces - Win32 Release" && "$(CFG)" != "faces - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "faces.mak" CFG="faces - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "faces - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "faces - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/faces.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/faces.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=ddraw.lib d3drm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/faces.pdb" /machine:I386 /out:"$(OUTDIR)/faces.exe" 
LINK32_OBJS= \
	"$(INTDIR)\faces.obj" \
	"$(INTDIR)\rmmain.obj" \
	"$(INTDIR)\rmmain.res"

"$(OUTDIR)\faces.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "faces - Win32 Debug"
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\faces.exe"
	-@erase "$(OUTDIR)\faces.ilk"
	-@erase "$(OUTDIR)\faces.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/faces.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib d3drm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/faces.pdb" /debug /machine:I386 /out:"$(OUTDIR)/faces.exe" 
LINK32_OBJS= \
	"$(INTDIR)\faces.obj" \
	"$(INTDIR)\rmmain.obj" \
	"$(INTDIR)\rmmain.res"
...
# Name "faces - Win32 Release"
# Name "faces - Win32 Debug"
