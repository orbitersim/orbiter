...
!MESSAGE No configuration specified.  Defaulting to morph - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "morph - Win32 Release" && "$(CFG)" != "morph - Win32 Debug"
...
!MESSAGE 
!MESSAGE "morph - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "morph - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/morph.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/morph.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=ddraw.lib d3drm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/morph.pdb" /machine:I386 /out:"$(OUTDIR)/morph.exe" 
LINK32_OBJS= \
	"$(INTDIR)\morph.obj" \
	"$(INTDIR)\rmmain.obj" \
	"$(INTDIR)\rmmain.res"

"$(OUTDIR)\morph.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\morph.exe"
	-@erase "$(OUTDIR)\morph.ilk"
	-@erase "$(OUTDIR)\morph.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/morph.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib d3drm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/morph.pdb" /debug /machine:I386 /out:"$(OUTDIR)/morph.exe" 
LINK32_OBJS= \
	"$(INTDIR)\morph.obj" \
	"$(INTDIR)\rmmain.obj" \
	"$(INTDIR)\rmmain.res"
...
"$(INTDIR)\morph.obj" : $(SOURCE) $(DEP_CPP_MORPH) "$(INTDIR)"
