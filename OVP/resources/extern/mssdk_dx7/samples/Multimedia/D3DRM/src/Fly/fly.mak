...
!IF "$(CFG)" == ""
CFG=fly - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to fly - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "fly - Win32 Release" && "$(CFG)" != "fly - Win32 Debug"
...
!MESSAGE 
!MESSAGE "fly - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "fly - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/fly.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/fly.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=ddraw.lib d3drm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/fly.pdb" /machine:I386 /out:"$(OUTDIR)/fly.exe" 
LINK32_OBJS= \
	"$(INTDIR)\fly.obj" \
	"$(INTDIR)\rmmain.obj" \
	"$(INTDIR)\rmmain.res"

"$(OUTDIR)\fly.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\fly.exe"
	-@erase "$(OUTDIR)\fly.ilk"
	-@erase "$(OUTDIR)\fly.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/fly.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib d3drm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/fly.pdb" /debug /machine:I386 /out:"$(OUTDIR)/fly.exe" 
LINK32_OBJS= \
	"$(INTDIR)\fly.obj" \
	"$(INTDIR)\rmmain.obj" \
	"$(INTDIR)\rmmain.res"
