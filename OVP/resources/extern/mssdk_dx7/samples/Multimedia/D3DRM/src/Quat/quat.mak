...
!MESSAGE No configuration specified.  Defaulting to quat - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "quat - Win32 Release" && "$(CFG)" != "quat - Win32 Debug"
...
!MESSAGE 
!MESSAGE "quat - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "quat - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/quat.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/quat.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=ddraw.lib d3drm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/quat.pdb" /machine:I386 /out:"$(OUTDIR)/quat.exe" 
LINK32_OBJS= \
	"$(INTDIR)\quat.obj" \
	"$(INTDIR)\rmmain.obj" \
	"$(INTDIR)\rmmain.res"

"$(OUTDIR)\quat.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\quat.exe"
	-@erase "$(OUTDIR)\quat.ilk"
	-@erase "$(OUTDIR)\quat.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/quat.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib d3drm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/quat.pdb" /debug /machine:I386 /out:"$(OUTDIR)/quat.exe" 
LINK32_OBJS= \
	"$(INTDIR)\quat.obj" \
	"$(INTDIR)\rmmain.obj" \
	"$(INTDIR)\rmmain.res"
...
"$(INTDIR)\quat.obj" : $(SOURCE) $(DEP_CPP_QUAT_) "$(INTDIR)"
