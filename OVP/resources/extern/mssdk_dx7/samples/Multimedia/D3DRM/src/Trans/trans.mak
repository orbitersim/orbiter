...
!MESSAGE No configuration specified.  Defaulting to trans - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "trans - Win32 Release" && "$(CFG)" != "trans - Win32 Debug"
...
!MESSAGE 
!MESSAGE "trans - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "trans - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/trans.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/trans.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=ddraw.lib d3drm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/trans.pdb" /machine:I386 /out:"$(OUTDIR)/trans.exe" 
LINK32_OBJS= \
	"$(INTDIR)\rmmain.obj" \
	"$(INTDIR)\rmmain.res" \
	"$(INTDIR)\trans.obj"

"$(OUTDIR)\trans.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\trans.exe"
	-@erase "$(OUTDIR)\trans.ilk"
	-@erase "$(OUTDIR)\trans.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/trans.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib d3drm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/trans.pdb" /debug /machine:I386 /out:"$(OUTDIR)/trans.exe" 
LINK32_OBJS= \
	"$(INTDIR)\rmmain.obj" \
	"$(INTDIR)\rmmain.res" \
	"$(INTDIR)\trans.obj"
