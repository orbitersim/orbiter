...
!MESSAGE No configuration specified.  Defaulting to hier1 - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "hier1 - Win32 Release" && "$(CFG)" != "hier1 - Win32 Debug"
...
!MESSAGE 
!MESSAGE "hier1 - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "hier1 - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
ALL : "$(OUTDIR)\hier1.exe"

CLEAN : 
	-@erase "$(INTDIR)\hier1.obj"
	-@erase "$(INTDIR)\rmmain.obj"
	-@erase "$(INTDIR)\rmmain.res"
	-@erase "$(OUTDIR)\hier1.exe"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/hier1.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/hier1.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=ddraw.lib d3drm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/hier1.pdb" /machine:I386 /out:"$(OUTDIR)/hier1.exe" 
LINK32_OBJS= \
	"$(INTDIR)\hier1.obj" \
	"$(INTDIR)\rmmain.obj" \
	"$(INTDIR)\rmmain.res"

"$(OUTDIR)\hier1.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\hier1.exe"
	-@erase "$(OUTDIR)\hier1.ilk"
	-@erase "$(OUTDIR)\hier1.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/hier1.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib d3drm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)/hier1.pdb" /debug /machine:I386 /out:"$(OUTDIR)/hier1.exe" 
LINK32_OBJS= \
	"$(INTDIR)\hier1.obj" \
	"$(INTDIR)\rmmain.obj" \
	"$(INTDIR)\rmmain.res"
...
"$(INTDIR)\hier1.obj" : $(SOURCE) $(DEP_CPP_HIER1) "$(INTDIR)"
