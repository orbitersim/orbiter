...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "lights - Win32 Debug"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/lights.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/lights.pdb" /machine:I386 /out:"$(OUTDIR)/lights.exe" 
LINK32_OBJS= \
	"$(INTDIR)\lights.obj" \
	"$(INTDIR)\winmain.res"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/lights.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/lights.pdb" /debug /machine:I386 /out:"$(OUTDIR)/lights.exe" 
LINK32_OBJS= \
	"$(INTDIR)\lights.obj" \
	"$(INTDIR)\winmain.res"
