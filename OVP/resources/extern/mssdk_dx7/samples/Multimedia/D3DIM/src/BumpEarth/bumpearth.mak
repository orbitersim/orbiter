...
!IF "$(CFG)" != "BumpEarth - Win32 Release" && "$(CFG)" !=\
 "BumpEarth - Win32 Debug"
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "BumpEarth - Win32 Debug"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/bumpearth.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib dxguid.lib winmm.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/bumpearth.pdb" /machine:I386 /out:"$(OUTDIR)/bumpearth.exe" 
LINK32_OBJS= \
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/bumpearth.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib dxguid.lib winmm.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/bumpearth.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/bumpearth.exe" 
LINK32_OBJS= \
	"$(INTDIR)\bumpearth.obj" \
	"$(INTDIR)\winmain.res"
...
"$(INTDIR)\bumpearth.obj" : $(SOURCE) $(DEP_CPP_BUMPE) "$(INTDIR)"
