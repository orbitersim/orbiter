...
!IF "$(CFG)" == ""
CFG=wbuffer - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to wbuffer - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "wbuffer - Win32 Release" && "$(CFG)" !=\
 "wbuffer - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "wbuffer.mak" CFG="wbuffer - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "wbuffer - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "wbuffer - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "wbuffer - Win32 Debug"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe

!IF  "$(CFG)" == "wbuffer - Win32 Release"
...
ALL : "$(OUTDIR)\wbuffer.exe"

CLEAN : 
	-@erase "$(INTDIR)\wbuffer.obj"
	-@erase "$(INTDIR)\winmain.res"
	-@erase "$(OUTDIR)\wbuffer.exe"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/wbuffer.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/wbuffer.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/wbuffer.pdb" /machine:I386 /out:"$(OUTDIR)/wbuffer.exe" 
LINK32_OBJS= \
	"$(INTDIR)\wbuffer.obj" \
	"$(INTDIR)\winmain.res"

"$(OUTDIR)\wbuffer.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "wbuffer - Win32 Debug"
...
CLEAN : 
	...
	-@erase "$(INTDIR)\winmain.res"
	-@erase "$(OUTDIR)\wbuffer.exe"
	-@erase "$(OUTDIR)\wbuffer.ilk"
	-@erase "$(OUTDIR)\wbuffer.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/wbuffer.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=ddraw.lib winmm.lib dxguid.lib ..\..\lib\d3dframe.lib kernel32.lib\
 ...
 /pdb:"$(OUTDIR)/wbuffer.pdb" /debug /machine:I386 /out:"$(OUTDIR)/wbuffer.exe" 
LINK32_OBJS= \
	"$(INTDIR)\wbuffer.obj" \
	"$(INTDIR)\winmain.res"
...
# Name "wbuffer - Win32 Release"
# Name "wbuffer - Win32 Debug"
...
"$(INTDIR)\wbuffer.obj" : $(SOURCE) $(DEP_CPP_WBUFF) "$(INTDIR)"
